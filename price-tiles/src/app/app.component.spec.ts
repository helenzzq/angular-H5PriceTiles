...
describe('AppComponent', () => {
  ...
  it(`should have as title 'price-tiles'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    expect(app.title).toEqual('price-tiles');
  });
  ...
  it('should render title', () => {
    ...
    expect(compiled.querySelector('.content span')?.textContent).toContain('price-tiles app is running!');
  });
});
